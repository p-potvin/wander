...
namespace Wander.UI.Theming
{
    public class VaultTheme
    {
        ...
        public string Mode { get; set; } = string.Empty; // "light" | "dark"
        ...
        public string AccentMuted { get; set; } = string.Empty;
        ...
        public string ErrorBg { get; set; } = string.Empty;
        public string Warning { get; set; } = string.Empty;
        public string WarningBg { get; set; } = string.Empty;
        public string Success { get; set; } = string.Empty;
        public string SuccessBg { get; set; } = string.Empty;
        public string Info { get; set; } = string.Empty;
        public string InfoBg { get; set; } = string.Empty;
